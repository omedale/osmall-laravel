...
class CreateMerchanttproductTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
		/* This table implement product:merchant = m:n relationship */
			...
			Schema::create('merchanttproduct', function (Blueprint $table) {
				$table->increments('id');
			...
			//	$table->index('merchant_id','mp_merchant_id_idx');
				 ...
				 */
				$table->integer('tproduct_id')->unsigned()->unique();
