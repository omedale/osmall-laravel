...
class PrivacyController extends Controller {
    ...
    public function getPrivacyPolicy() {
        $termsnCondition = privacyPolicy::all('id', 'ipaddress', 'agree')->toArray();
        ...
        foreach ($termsnCondition as $key => $value) {
            ...
            $termsnConditions[$key]['data-privacypolicy-id'] = $value['id'];
        }
        return response()->json($termsnConditions);
    }

    public function getPrivacyPolicyTable() {
        return view('admin/privacyPolicyTree');
    }
     ...
     * @method Ajax POST
     */
    public function postNewPrivacyPolicy(Request $request) {
        ...
        if (!empty($formData)) {
            ...
            privacyPolicy::insert($termsnConditionData);
        }
     ...
     * @method Ajax POST
     */
    public function postEditPrivacyPolicy(Request $request) {
        ...
        privacyPolicy::where('id', '=', $formData['data-privacypolicy-id'])->update($termsnConditionData);
     ...
     * @method Ajax POST
     */
    public function removePrivacyPolicy() {
        $formData = Input::all();
        privacypolicy::where('id', '=', $formData['data-privacypolicy-id'])->delete();
