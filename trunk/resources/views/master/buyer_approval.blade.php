...
<div class="container" style="margin-top:30px;">
	...
	<div class='row'>
		<div class='col-xs-6'><h2>Buyer Master: Status</h2></div>
		<div class='col-xs-6'>
			@if(!is_null($idbuyer))
				<a class="btn btn-default role_status_button pull-right add_remark" role="buyer" do_status="add_remark" current_role_id="{{$idbuyer->id}}" style="width: 110px !important;" href="javascript:void(0)"> Add Remark </a>
			@else
				&nbsp;
			@endif
		</div>	
		...
		$.ajax({
			...
			success: function (data) {
				...
				for (i=0; i < data.length; i++) {
					...
					html += "<tr>";
					html += "<td>"+(i+1)+"</td>";
					html += "<td><a href='../../admin/popup/user/"+id_buyer+"' class='update' data-id='"+id_buyer+"'>"+obj.nbuyer_id+"</a></td>";
					html += "<td>"+obj.status+"</td>";
					html += "<td><a href='../../admin/popup/user/"+obj.user_id+"' class='update' data-id='"+obj.user_id+"'>"+obj.nadmin_id+"</td>";
