    ...
    <div class="container" style="margin-top:30px;">
		@include('admin/panelHeading')
            <div class="equal_to_sidebar_mrgn">
				<div class='row'>
					<div class='col-xs-6'><h2>Product Master: Remarks</h2></div>
					<div class='col-xs-6'>
						&nbsp;
					</div>	
							...
							@if(isset($sections) && !empty($sections))
								@foreach($sections as $section)
									<?php
										...
										if($wholesaleprod == 0 && ($section['name'] == 'informationb2b' || $section['name'] == 'detailb2b' || $section['name'] == 'specificationb2b' || $section['name'] == 'b2b')){
											$rstyle = "background-color: rgba(255, 255, 255, 0.4);";
