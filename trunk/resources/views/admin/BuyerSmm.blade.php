    ...
    <div class="container" style="margin-top:30px;">
        <div class="row">
            ...
            <td><select id="filtername" name="search_name">
                 ...
                 <option value="smm">Social Media Marketeer</option>
             </select></td>
      ...
      @foreach ($buyers as $key=>$value)
            ...
            ?>
                ...
                <td>{{(!empty($value->company_reg_no)) ? $value->company_reg_no : null}} </td>
                <td>{{(!empty($value->country_name)) ? $value->country_name : null}}</td>
                <td>{{(!empty($value->city_name)) ? $value->city_name : null}}</td>
                <td>{{(!empty($value->role_name)) ? $value->role_name : null}}</td>
                <td>{{(!empty($value->potential_industry)) ? $value->potential_industry : null}}</td>
                <td>{{(!empty($value->products)) ? $value->products : null}}</td>
                <td>{{(!empty($value->amount)) ? $value->amount : null}}</td>
                 <td>{{(!empty($value->account_name1)) ? $value->account_name1 : null}} </td>
                <td> {{(!empty($value->account_number1)) ? $value->account_number1 : null}}</td>
                <td>{{(!empty($value->bank_name)) ? $value->bank_name : null}}</td>
                <td>{{(!empty($value->bank_code)) ? $value->bank_code : null}} </td>
                <td>{{(!empty($value->iban)) ? $value->iban : null}}</td>
                <td>{{(!empty($value->swift)) ? $value->swift : null}}</td>
