...
<div class="col-sm-12"> 
			...
			<div class="row">
                  <h2 style="text-align:left; float:left">Hyper</h2> <h4 style="text-align:right;float:right"><span id="ow_product_count">{{count($ow_product)}}</span> <small>Hyper  @if(count($ow_product)!=1)products @else product @endif
             found</small></h4>
            <p> </p>
				  <div class="col-sm-12">
				    <div class="row">
