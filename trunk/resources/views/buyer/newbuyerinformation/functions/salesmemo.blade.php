...
<div class="col-sm-2">
	<a href="javascript:void(0)" class='btn btn-info salesgo' style="background-color: #7474FD; border-color: #747450; color: black;">Sales Memo</a>
</div>
...
<script type="text/javascript">
    $(document).ready(function(){
		...
		$(document).delegate( '.salesgo', "click",function (event) {
			...
			window.open(JS_BASE_URL + '/salesmemo/' + userid + '/' + fairrecruiter + '/' + saleslocation, '_blank');	
		});	
    });
</script>	
