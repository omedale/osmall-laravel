...
<!--                                                        <div class="col-sm-11"-->
<!--                                                             style="text-align:right;padding-right:0;right:-50px">-->
...
<!--                                                </div>-->
                            ...
                            <div class="col-sm-4 col-sm-offset-8 text-right" style="margin-top:20px">
                                ...
                                <div class="btn-group-lg select-SMM-group hidden">
                                    <div>
                                        SMM Quota: <span id="product_quota_max"></span>
                                    </div>
                                    <button type="button" id="select-SMM"
                                        class="btn btn-green btn-round text-green select-SMM ">Select SMM</button>
                                </div>
...
//                });
        ...
        $(".select-SMM").on('click', function () {
            btn = $(this);
            var num_quotes = parseInt($("#product_quota_max").html()) || 0; //get num_qoute via ajax
            if(btn.html() === "Select SMM")
            {
                if (num_quotes) {
                    --num_quotes; //update num_qoute via ajax
                }
                btn.html("Done");
            }else{
                var max_quoutes = 5; //get max via ajax
                if (num_quotes<=max_quoutes) {
                    ++num_quotes; //update num_qoute via ajax
                }
                btn.html("Select SMM");
            }
            $("#product_quota_max").html(num_quotes.toString());
        });
