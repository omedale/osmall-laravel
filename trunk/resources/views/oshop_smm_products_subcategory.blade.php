...
<div class="col-sm-12 margin-top">
	<button class="btn btn-green pull-right product-selected" id="blast_scat" type="button" disabled>SEND</button>
</div>	
    ...
    $(document).ready(function(){
        ...
        $('body').click(function(evt){
            if ($(evt.target).hasClass('added')) {
                ...
                $('#blast_scat').prop('disabled',false);
