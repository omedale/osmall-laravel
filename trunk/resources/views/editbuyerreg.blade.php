            ...
            <div class="row">
                <div data-spy="scroll" style="display: none;" class="static-tab">
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        <li role="presentation" class="active floor-navigation"><a href="#buyer-detail">Buyer Details</a>
                        </li>
                        ...
                        <li role="presentation" class="floor-navigation"><a href="#update">Update</a></li>
                    </ul>
                </div>
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="col-xs-3 no-padding no-margin">
                                    <div class="imagePreview" id="imagePreview1"
                                        ...
                                        <?php } ?>">
                                        <div class="Xphoto closeBtn" id="Xphoto1" style="cursor:pointer; margin-left:92%;
                                            <?php if($image[1]!=""){ ?>
                                                display:block;
                                            <?php }else{ ?>
                                                display:none;
                                            <?php } ?>
                                            width:20px;margin-top:2px">
                                            <span id="closeboton" class="fa fa-times-circle fa-lg "
                                                title="remove"></span>
                                        </div>
                                        <input style="height: 135px;" class="uploadimage"
                                            type="file" id="photo1" name="photo1">
                                            <?php if($image[1]!=""){ ?>
                                        <input type="hidden" id="photo1_old" value="1" name="photo1_old">
                                        <?php }else{ ?>
                                            <input type="hidden" id="photo1_old" value="0" name="photo1_old">
                                            <?php } ?>
                                    </div>
                                    ...
                                    <div class="no-padding imagePreview" id="imagePreview2"
                                        ...
                                        <?php } ?>">
                                        <div class="Xphoto closeBtn" id="Xphoto2"
                                            style="cursor:pointer; margin-left:92%;
                                            <?php if($image[2]!=""){ ?>
                                                display:block;
                                            <?php }else{ ?>
                                                display:none;
                                        ...
                                        <input style="height: 135px;" class="uploadimage"
                                            ...
                                            <?php if($image[2]!=""){ ?>
                                        <input type="hidden" id="photo2_old" value="1" name="photo2_old">
                                        <?php }else{ ?>
                                            <input type="hidden" id="photo2_old" value="0" name="photo2_old">
                                            <?php } ?>
                                    </div>
                                </div>

                                <div class="col-xs-3 no-padding no-margin">
                                    <div class="imagePreview" id="imagePreview3" style="height: 150px; margin-bottom: 0px; <?php if($image[3]!=""){ ?>
                                            background-size: cover;
                                            background-position: center top;
                                            background-image: url('{{asset($image[3])}}');<?php } ?>">
                                        <div class="Xphoto closeBtn" id="Xphoto3" style="cursor:pointer; margin-left:92%; <?php if($image[3]!=""){ ?> display:block; <?php }else{ ?> display:none; <?php } ?>width:20px;margin-top:2px">
                                            <span id="closeboton" class="fa fa-times-circle fa-lg " title="remove"></span>
                                        </div>
                                        <input style="height: 135px;" class="uploadimage" type="file" id="photo3" name="photo3"></div>
                                        <?php if($image[3]!=""){ ?>
                                        <input type="hidden" id="photo3_old" value="1" name="photo3_old">
                                        <?php }else{ ?>
                                            <input type="hidden" id="photo3_old" value="0" name="photo3_old">
                                            <?php } ?>
                                    <div class="no-padding imagePreview" id="imagePreview4" style="height: 150px; margin-bottom: 5px; <?php if($image[4]!=""){ ?>
                                            background-size: cover;
                                            background-position: center top;
                                            background-image: url('{{asset($image[4])}}');<?php } ?>">
                                        <div class="Xphoto closeBtn" id="Xphoto4" style="cursor:pointer; margin-left:92%; <?php if($image[4]!=""){ ?> display:block; <?php }else{ ?> display:none; <?php } ?> width:20px;margin-top:2px">
                                            <span id="closeboton" class="fa fa-times-circle fa-lg " title="remove"></span>
                                        </div>
                                        <input style="height: 135px;" class="uploadimage" type="file" id="photo4" name="photo4"></div>
                                        <?php if($image[4]!=""){ ?>
                                        <input type="hidden" id="photo4_old" value="1" name="photo4_old">
                                        <?php }else{ ?>
                                            <input type="hidden" id="photo4_old" value="0" name="photo4_old">
                                            <?php } ?>
                                </div>
                                <div class="col-xs-3 no-padding no-margin">
                                    <div  class="imagePreview" id="imagePreview5" style="height: 150px; margin-bottom: 0px; <?php if($image[5]!=""){ ?>
                                            background-size: cover;
                                            background-position: center top;
                                            background-image: url('{{asset($image[5])}}');<?php } ?>">
                                        <div class="Xphoto closeBtn" id="Xphoto5" style="cursor:pointer; margin-left:92%; <?php if($image[5]!=""){ ?> display:block; <?php }else{ ?> display:none; <?php } ?> width:20px;margin-top:2px">
                                            <span id="closeboton" class="fa fa-times-circle fa-lg " title="remove"></span>
                                        </div>
                                        <input style="height: 135px;" class="uploadimage" type="file" id="photo5" name="photo5"></div>
                                        <?php if($image[5]!=""){ ?>
                                        <input type="hidden" id="photo5_old" value="1" name="photo5_old">
                                        <?php }else{ ?>
                                            <input type="hidden" id="photo5_old" value="0" name="photo5_old">
                                            <?php } ?>
                                    <div class="no-padding imagePreview" id="imagePreview6" style="height: 150px; margin-bottom: 5px; <?php if($image[6]!=""){ ?>
                                            background-size: cover;
                                            background-position: center top;
                                            background-image: url('{{asset($image[6])}}');<?php } ?>">
                                        <div class="Xphoto closeBtn" id="Xphoto6" style="cursor:pointer; margin-left:92%; <?php if($image[6]!=""){ ?> display:block; <?php }else{ ?> display:none; <?php } ?> width:20px;margin-top:2px">
                                            <span id="closeboton" class="fa fa-times-circle fa-lg " title="remove"></span>
                                        </div>
                                        <input style="height: 135px;" class="uploadimage" type="file" id="photo6" name="photo6"></div>
                                        <?php if($image[6]!=""){ ?>
                                        <input type="hidden" id="photo6_old" value="1" name="photo6_old">
                                        <?php }else{ ?>
                                            <input type="hidden" id="photo6_old" value="0" name="photo6_old">
                                            <?php } ?>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-7">
                                <div class="col-xs-12 no-padding ">
                                    ...
                                    <div class="col-sm-6 col-xs-12">
                                        <input type="text" required name="email" id="email_valitation"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                <div class="col-xs-12 no-padding ">
                                    ...
                                    <div class="col-xs-7">
                                        <select MULTIPLE name="language[]" required="" class="form-control col-xs-12">
                                            @if(isset($languages))
                        ...
                        <div class="row">
                            <div class="col-sm-7">
                                <div class="col-xs-12 no-padding ">
                                    ...
                                    <div class="col-sm-6 col-xs-12">
                                        {{-- Input One --}}
                                        <select name="occupation" required="" class="form-control col-xs-12 ">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="row margin-top">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" required="" id="default1" name="default1" value="{{$def->line1 or $em}}" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="row margin-top">
                                                ...
                                                <div class="col-sm-4">
                                                @if($defstate != "")
                                                    <select name="state" required="" placeholder="State" id="states" class="form-control col-xs-12 validator">
                                            ...
                                            <div class="row margin-top">
                                                ...
                                                <div class="col-sm-4">
                                                    <select style="width: 100%;" required="" class="form-control selectpicker show-menu-arrow" id="cities" name="defaultcity_name" data-style="btn-green" required>
                                                        <option value="">Choose Option</option>
                                                            @if(isset($defcity))
                                                            @if ($defcityall!="")
                                            ...
                                            <div class="row margin-top">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="text" required="" name="default_postcode" id="default_postcode_1" value="{{$def->postcode or $em}}" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <br>
                                    ...
                                    <div class="link-facebook">
                                       ...
                                       <input type="text"   value="{{$buyer_social_url}}" class="form-control pull-right" disabled="disabled" style="color: blue;cursor: pointer; width: 100%">
                                        ...
                                        <div class="col-sm-5 pull-left" style="margin-bottom:20px;">
