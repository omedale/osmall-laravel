...
<head>
    ...
    <title>{{$title or 'OpenSupermall'}}</title>
...
[class^="icon-"],[class*=" icon-"]{display:inline-block;width:13px;height:13px;*margin-right:.3em;line-height:13px;vertical-align:text-top;background-image:url("https://az340737.vo.msecnd.net/resources/glyphicons-halflings.png");background-position:13px 13px;background-repeat:no-repeat;margin-top:1px}
...
.btn-large{padding:9px 13px;font-size:15px;line-height:normal;-webkit-border-radius:5px;-moz-border-radius:5px;border-radius:5px}
...
.alert{padding:8px 35px 8px 13px;margin-bottom:20px;text-shadow:0 1px 0 rgba(255,255,255,0.5);background-color:#fcf8e3;border:1px solid #fbeed5;-webkit-border-radius:4px;-moz-border-radius:4px;border-radius:4px;color:#c09853}
.alert h4{margin:0}
.alert .close{position:relative;top:-2px;right:-21px;line-height:20px}
.alert-success{background-color:#dff0d8;border-color:#d6e9c6;color:#468847}
.alert-danger,.alert-error{background-color:#f2dede;border-color:#eed3d7;color:#b94a48}
.alert-info{background-color:#d9edf7;border-color:#bce8f1;color:#3a87ad}
.alert-block{padding-top:13px;padding-bottom:13px}
...
.navbar-search .search-query{margin-bottom:0;padding:4px 13px;font-family:"Segoe UI","Helvetica Neue",Helvetica,Arial,sans-serif;font-size:13px;font-weight:normal;line-height:1;-webkit-border-radius:15px;-moz-border-radius:15px;border-radius:15px}
...
.label,.badge{font-size:10.998px;font-weight:bold;line-height:13px;color:#fff;vertical-align:baseline;white-space:nowrap;text-shadow:0 -1px 0 rgba(0,0,0,0.25);background-color:#999}
...
{{-- xyz --}}
	<div class="container">
		...
		<div class="row">
				...
				<tr>
					<?php $image_name=rawurlencode('OpenSupermall Official Logo PNG.png');?>
					<td style=""><a href="{{route('home')}}"><img src="{{url().'/images/category/'.$image_name}}" class="img" alt="OpenSupermall" height="50px" width="180px"></a></td>
				</tr>
		...
		<tr>
			<td style="font-family:Helvetica,sans-serif;font-size:13px;line-height:20px;color:#505050;font-weight:none;border-top:1px solid #ddd">
				<p> 	
				You will need to enter your Email Address and Password whenever you use your account. If you did not intend to register an account, someone may have registered with your information by mistake. Please visit our <a href="{{url()}}/opensupport">Online Customer Support Center</a></p>
			</td>
		</tr>
		<tr style="font-family:Helvetica,sans-serif;font-size:13px;line-height:20px;color:#505050;font-weight:none;border-top:1px solid #ddd">
		<td>
			This e-mail message has been delivered from a send-only address. Please do not reply to this message. For more information about your Account please login and view your dashboard.
		</td>
		</tr>
